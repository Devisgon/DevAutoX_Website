  ...
  const testimonials = [
    {
      ...
      review:
        "I had an excellent experience working with Absar. He built a fast, professional website for my business that exceeded my expectations. One of the highlights was the automated booking system he created — it works flawlessly and adds ...",
      client: "Upwork Client",
    },
    {
      title: "Website for AI Generated Business",
      review:
        "Overall great experience working with Absar. Everything was done on time and great communication throughout the process. Also his availability was great despite the different time zones. I’m looking forward to our future projects.",
      client: "Upwork Client",
    },
    {
      title: "Responsive WordPress Site",
      review:
        "Their work quality was excellent, delivered on time, and communication was always clear. Very cooperative, responsive, and easy to work with. I would gladly work with them again and highly recommend their services.",
      client: "Upwork Client",
    },
  ];
    ...
    <>
      ...
      <section className="relative bg-white max-sm:pt-9 flex justify-center px-9 md:px-19">
        ...
        >
          ...
          >
            “Our work speaks through our clients’ success. From startups to
            enterprises, we’ve delivered{" "}
          ...
          <div className="mt-10 flex flex-col md:flex-row gap-10 items-start">
            ...
            >
              <p className="text-black text-[14px] font-regular text-justify font-poppins leading-relaxed">
                The client wanted a modern, user-friendly website to showcase
                4042 Chalet, a luxury seaside retreat in Kuwait, and provide
                guests with an easy way to explore amenities and make bookings.
              </p>
              ...
              <p className="text-black text-[13px] font-regular text-justify font-poppins mt-2 leading-relaxed">
                We designed and developed a fully responsive website with a
                clean layout, seamless navigation, and optimized visuals to
                highlight the chalet’s key features—private pool, outdoor
                garden, BBQ space, and furnished living areas. The project
                included:
              </p>
      ...
      <section className="py-8 px-6 md:px-16 -mt-21 lg:px-24 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            bookings through a seamless, professional experience.
          </motion.p>
      ...
      <section className="py-12 px-6 md:px-16 lg:px-24 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mt-10 flex flex-col md:flex-row gap-10 items-start">
            ...
            >
              <p className="text-black text-[14px] font-regular text-justify font-poppins leading-relaxed">
                The client wanted to build an AI-driven personal branding
                platform where users could generate professional bios,
                summaries, and resumes. The goal was to simplify personal
                branding and make it smarter through artificial intelligence.
              </p>
              ...
              <p className="text-black text-[13px] font-regular font-poppins mt-2">
                Web & Mobile Design Consultation, AI App Development, Test
              ...
              <p className="text-black text-[13px] font-regular text-justify font-poppins mt-2 leading-relaxed">
                We designed and developed the complete web application from
                scratch, covering both frontend and backend. The solution
                included:
              </p>
              <ul className="list-disc pl-5 mt-2 text-black text-[13px] font-regular font-poppins space-y-1">
                <li>
                  Integration of OpenAI for intelligent content generation
                </li>
                <li>Secure payment system using Stripe</li>
                <li>Clean, responsive dashboard for smooth user interaction</li>
                <li>
                  Scalable and modern tech stack for performance and reliability
                </li>
              </ul>
            </motion.div>
          </div>
      ...
      <section className="py-8 px-6 md:px-16 -mt-22 lg:px-24 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          >
            The platform was successfully delivered, meeting all client
            expectations. PersonaCraft.ai is now live, helping professionals
            enhance their online presence with AI-
            <span className="hidden md:inline">
              <br />
            </span>
            powered personal branding tools.
          </motion.p>
      ...
      <section className="py-12 px-6 md:px-16 lg:px-24 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mt-10 flex flex-col md:flex-row gap-10 items-start">
            ...
            >
              <p className="text-black text-[14px] font-regular text-justify font-poppins leading-relaxed">
                NovaOne Property wanted a professional, high-converting website
                to promote their wide range of residential and commercial
                cleaning services across Melbourne. The client’s focus was on
                building trust, simplifying service bookings, and showcasing
                their eco-friendly commitment to sustainability.
              </p>
              ...
              <p className="text-black text-[13px] font-regular text-justify font-poppins mt-2">
                Web Development, Web API, WordPress Customization, AI Builder,
                Test Execution
                <span className="hidden md:inline">
                  <br />
                </span>
              ...
              <p className="text-black text-[13px] font-regular text-justify font-poppins mt-2 leading-relaxed">
                Team DevAutoX handled the complete WordPress website
                development,
                <span className="hidden md:inline">
                  <br />
                </span>{" "}
              ...
              <ul className="list-disc pl-5 mt-2 text-black text-[13px] font-regular font-poppins space-y-1">
                ...
                <li>
                  Built custom service pages for cleaning and maintenance.
                </li>
                <li>
                  Added booking forms, clear CTAs, and structured sections.
                </li>
                <li>Optimized SEO, speed, and mobile performance.</li>
                <li>
                  Highlighted eco-friendly partnerships and sustainability.
                </li>
              </ul>
            </motion.div>
      ...
      <section className="py-8 px-6 md:px-16 -mt-22 lg:px-24 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          <motion.p
            ...
            className="text-black mt-2 text-[14px] font-regular font-poppins leading-relaxed md:whitespace-nowrap"
          >
            The new website provided NovaOne with a strong digital presence,
            helping them connect with both residential and commercial clients.
            With user-friendly navigation,
            <span className="hidden md:inline">
              <br />
            </span>{" "}
            optimized performance, and sustainable branding, NovaOne is now
            positioned as a trusted and scalable cleaning brand in Melbourne.
          </motion.p>
