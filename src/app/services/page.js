...
export default function About() {
  ...
  const sections = [
    {
      ...
      content:
        "Frontend Development focuses on creating the visual and interactive parts of a website or application that users see and interact with. It involves designing layouts, typography, and interactive elements to ensure seamless navigation and an intuitive user experience. A well-crafted frontend enhances engagement, improves usability, and strengthens your brand identity.",
    },
    {
      title: "Backend Development",
      content:
        "Backend Development involves building the core logic, databases, and server-side operations that power your application. This is where the magic happens behind the scenes, ensuring the platform is secure, efficient, and scalable. A robust backend is essential for managing data, processing requests, and guaranteeing your application performs reliably.",
    },
    {
  ...
  const api = [
    {
      ...
      content:
        "We integrate your applications with popular third-party services such as payment gateways, CRMs, analytics platforms, and social media tools. This extends your platform’s capabilities without reinventing the wheel. Seamless integrations enhance efficiency, reduce errors, and provide users with a richer experience. By connecting to the right tools, your business gains flexibility and accelerates digital transformation.",
    },
    {
      title: "Custom API Development",
      content:
        "We create tailored APIs to connect your internal systems or partner applications. Whether RESTful or GraphQL, our APIs are designed for flexibility, scalability, and long-term usability. Custom APIs ensure your business processes flow smoothly, adapting easily as your operations grow. With well-documented and structured APIs, your teams can innovate faster and collaborate more effectively.",
    },
    {
  ...
  const cyber = [
    ...
    },
    {
      ...
      content:
        "We secure sensitive data through strong encryption, access controls, and secure storage practices. This prevents data breaches and ensures information stays confidential. Our strategies protect customer trust while meeting industry regulations and compliance standards. Your data remains protected wherever it travels or resides.",
    },
    {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              ...
              <div>
                ...
                <p className="text-[14px] font-regular font-Poppins text-black mt-3 mb-6">
                  We build custom, responsive, and scalable digital solutions
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              ...
              <div className="order-1 md:order-1">
                ...
                <p className="text-[14px] font-normal font-Poppins text-black mt-3 mb-6">
                  We craft smart, automated solutions that boost efficiency and
                  provide powerful, data-driven insights.
                </p>
          ...
          <AnimateSection>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              ...
              <div>
                ...
                <p className="text-[14px] font-regular font-Poppins text-black mt-3 mb-6">
                  We build seamless API connections that enable your systems to
                  share data and work together as one.
                </p>
          ...
          <AnimateSection>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              ...
              <div className="order-1 md:order-2">
                ...
                <p className="text-[14px] font-normal font-Poppins text-black mt-3 mb-6">
                  We build and manage cloud systems for uptime, scalability, and
                  performance.
                </p>
